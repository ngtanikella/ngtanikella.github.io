...
<div class="cv-layout">
  ...
  <nav class="cv-nav" aria-label="CV sections">
    <ul>
      <li><a href="#profiles" class="cv-nav-link">Professional Profiles</a></li>
      <li><a href="#expertise" class="cv-nav-link">Expertise</a></li>
      <li><a href="#education" class="cv-nav-link">Education</a></li>
      <li><a href="#research" class="cv-nav-link">Research Experience</a></li>
      <li><a href="#teaching" class="cv-nav-link">Teaching & Mentoring</a></li>
      <li><a href="#publications" class="cv-nav-link">Publications</a></li>
      <li><a href="#skills" class="cv-nav-link">Skills</a></li>
      <li><a href="#service" class="cv-nav-link">Service & Outreach</a></li>
      <li><a href="#references" class="cv-nav-link">References</a></li>
    </ul>
  </nav>
  ...
  <div class="cv-content">
    ...
    <section id="teaching" class="cv-section">
      ...
      <div class="cv-entry">
        <div class="cv-entry-header">
          <span class="cv-entry-title"><strong>ME 2010, ME 3310 — Statics & Mechanics of Materials</strong></span>
      ...
      <div class="cv-entry">
        <div class="cv-entry-header">
          <span class="cv-entry-title"><strong>MSE 4777 / MSE 5777 — 3D Printer Assembly</strong></span>

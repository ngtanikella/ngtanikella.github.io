...
<section id="teaching" class="cv-section">
  <div class="cv-section-grid">
    ...
    <div class="cv-section-body">
      ...
      <div class="cv-item">
        <div class="cv-item-left">Authored lab reports and developed SOPs for training 10+ peers and students, ensured lab safety rules and regulations</div>
        <div class="cv-item-right"><div class="cv-item-date">2022-2025</div></div>
      </div>
      <div class="cv-item">
        <div class="cv-item-left">Coached prospective students on the basics of 3-D printing and mechanical design. Provided hands-on learning experience with 3-D printers and CAD projects</div>

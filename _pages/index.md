...
I am an Assistant Professor of Mechanical Engineering at <img src="{{site.url}}{{site.baseurl}}/images/experience/McNeese.png" alt="McNeese State University" class="inline-logo">[McNeese State University](https://www.mcneese.edu/){:target="_blank"}.
Prior to that, I was a Postdoctoral fellow at the <img src="{{site.url}}{{site.baseurl}}/images/experience/UTA.png" alt="University of Texas at Austin" class="inline-logo">[University of Texas at Austin](https://www.utexas.edu/){:target="_blank"}. 
